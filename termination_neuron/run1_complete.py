...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run complete prompting on IPJ completion benchmark.")
...
def main() -> None:
    args = parse_args()
    save_dir = f"outputs/run1_complete_prompting/{args.model_name}"
