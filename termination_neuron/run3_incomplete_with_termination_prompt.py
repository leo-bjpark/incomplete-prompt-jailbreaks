...
from utils import get_termination_prompt


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run incomplete prompting with termination-style system prompt.")
    ...
    parser.add_argument("--termination_prompt_version", type=str, default="1")
    parser.add_argument("--termination_prompt_type", type=str, default="termination")
...
def main() -> None:
    ...
    save_dir = (
        f"outputs/run3_incomplete_{augment_type}_{args.termination_prompt_type}_{args.termination_prompt_version}/"
        f"{args.model_name}"
    )

    common_prompt = get_termination_prompt(args.termination_prompt_type, args.termination_prompt_version)
